...
public class CameraController : MonoBehaviour
{
    ...
    private float filteredUpInput = 0f;
    private float filteredTurnInput = 0f;

    public bool InputMapToCircular = true;

    public float upInputFilter = 5f;
    ...
    void Update()
    {
        ...
        float h = Input.GetAxisRaw("Pitch");// setup h variable as our horizontal input axis
        float v = Input.GetAxisRaw("Roll"); // setup v variables as our vertical input axis
        ...
        filteredUpInput = Mathf.Clamp(Mathf.Lerp(filteredUpInput, v,
            Time.deltaTime * upInputFilter), -forwardSpeedLimit, forwardSpeedLimit);
